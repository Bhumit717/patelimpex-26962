...
const MediterraneanMarkets = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <SEOHead title="Mediterranean Markets | Patel Impex" description="Mediterranean Markets - Expert services and information by Patel Impex." canonicalUrl="/more/mediterranean-markets" />
      <Navigation />
