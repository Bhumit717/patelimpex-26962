...
const CertificateOfOrigin = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <SEOHead title="Certificate Of Origin | Patel Impex" description="Certificate Of Origin - Expert services and information by Patel Impex." canonicalUrl="/more/certificate-of-origin" />
      <Navigation />
