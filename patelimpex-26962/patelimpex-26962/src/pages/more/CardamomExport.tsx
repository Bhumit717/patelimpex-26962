...
const CardamomExport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <SEOHead title="Cardamom Export | Patel Impex" description="Cardamom Export - Expert services and information by Patel Impex." canonicalUrl="/more/cardamom-export" />
      <Navigation />
