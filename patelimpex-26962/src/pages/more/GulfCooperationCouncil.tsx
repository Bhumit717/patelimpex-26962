...
const GulfCooperationCouncil = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <SEOHead title="Gulf Cooperation Council | Patel Impex" description="Gulf Cooperation Council - Expert services and information by Patel Impex." canonicalUrl="/more/gulf-cooperation-council" />
      <Navigation />
