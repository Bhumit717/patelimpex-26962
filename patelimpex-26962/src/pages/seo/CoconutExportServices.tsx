        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-slate-800 mb-3">What is the minimum order quantity for Coconut export to Global Markets?</h3>
              <p className="text-slate-600 leading-relaxed">Our minimum order quantity for Coconut to Global Markets typically starts from 1 FCL (Full Container Load), but we can arrange smaller trial shipments of 5-10 metric tons depending on the customized packaging requirements for the Global Markets market.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-slate-800 mb-3">What documents do you provide for importing Coconut into Global Markets?</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-600 leading-relaxed">Transit times to Global Markets typically range from 26 days, depending on the specific port of discharge and shipping line schedules. We exclusively partner with top-tier logistics providers to ensure timely delivery of your Coconut.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-slate-800 mb-3">Can you provide customized packaging for Coconut in Global Markets?</h3>
              <p className="text-slate-600 leading-relaxed">Yes, we offer fully customizable packaging options for Coconut, including private labeling, branding, and specific bag sizes (25kg, 50kg, retail packs) compliant with Global Markets's labeling and packaging regulations.</p>
            </div>
          </div>
        </div>
      </div>
