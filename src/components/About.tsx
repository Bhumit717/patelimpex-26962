      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center group/stat cursor-pointer transform hover:scale-105 transition-all duration-300">
                  <div className="nm-card p-6 flex flex-col items-center justify-center h-full">
          ...
          <div className="relative group">
            ...
            <div className="absolute -bottom-8 -left-8 nm-card p-8 rounded-[50px] transform hover:scale-105 transition-all duration-300 z-20">
              <div className="text-center">
                <Zap className="h-8 w-8 mx-auto mb-2 text-yellow-500" />
                <div className="text-4xl font-black mb-2 text-slate-800">15+</div>
                <div className="text-sm font-semibold uppercase tracking-wide text-slate-500">Years of Excellence</div>
              </div>
            </div>

            {/* Floating trust badge */}
            <div className="absolute -top-6 -right-6 nm-card p-6 rounded-[50px] transform hover:scale-105 transition-all duration-300 z-20">
              <div className="text-center">
                <Award className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                <div className="text-xs font-bold text-slate-800">ISO Certified</div>
                <div className="text-xs text-slate-500">Govt. Recognized</div>
              </div>
            </div>
          </div>
        </div>
