  ...
  return (
    <header className={`fixed w-full z-50 transition-all duration-700 ${isScrolled ? 'top-0 py-1' : 'top-0 py-3'}`} role="banner">
      <div className="container mx-auto px-4 md:px-6">
        <nav className={`transition-all duration-700 flex justify-between items-center border border-slate-200/50 bg-white/80 backdrop-blur-xl px-6 lg:px-12 ${isScrolled ? 'h-16' : 'h-20 md:h-24'}`}>
          {/* Brand */}
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="w-10 h-10 md:w-14 md:h-14 overflow-hidden border-2 border-slate-100 group-hover:scale-110 transition-transform duration-700">
          ...
          <div className="flex items-center space-x-4 lg:space-x-8">
            ...
            <Link to="/inquiry" className="group">
              <button className="!h-10 md:!h-12 !px-4 md:!px-8 bg-slate-900 text-white hover:bg-emerald-600 transition-all duration-500 flex items-center gap-3">
            ...
            <button
              ...
              className="lg:hidden ml-4 w-10 h-10 flex items-center justify-center bg-slate-50 border border-slate-200 text-slate-900 hover:bg-emerald-50 transition-colors"
