                ...
                <div className="relative p-8 md:p-12">
                    <div className="text-center mb-10">
                        ...
                        <DialogTitle className="text-3xl font-black text-foreground font-graduate uppercase tracking-tight mb-2">
                            Unlock <span className="text-accent-ink">News</span>
                        </DialogTitle>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-4">
                            <div className="relative group">
                                ...
                                <input
                                    required
                                    className="w-full pl-12 pr-4 py-4 bg-secondary border-2 border-transparent rounded-2xl focus:border-border/20 focus:bg-card transition-all outline-none font-semibold text-foreground placeholder:text-muted-foreground"
