    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50" role="complementary" aria-label="WhatsApp contact widget">
        <button
          ...
          className="bg-green-500 hover:bg-green-600 text-white p-4 transition-all duration-300 transform hover:scale-110 animate-bounce focus:ring-2 focus:ring-green-400 focus:outline-none"
      ...
      {isOpen && (
        <div
          id="whatsapp-popup"
          className="fixed bottom-24 right-6 z-50 bg-white border border-gray-200 w-80 max-w-[calc(100vw-2rem)] animate-fade-in"
          role="dialog"
        ...
        >
          <header className="bg-green-500 text-white p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-white/20 flex items-center justify-center" aria-hidden="true">
          ...
          <div className="p-4">
            <div id="whatsapp-description" className="bg-green-50 p-3 mb-4">
            ...
            <button
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white py-3 px-4 font-medium transition-colors duration-200 flex items-center justify-center space-x-2 focus:ring-2 focus:ring-green-400 focus:outline-none"
