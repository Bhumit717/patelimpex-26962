...
const PopularPages = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900" aria-label="Popular export pages and resources">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {Object.entries(popularLinks).map(([category, links]) => {
            ...
            return (
              <div key={category} className="bg-gray-800/50 rounded-2xl p-6 border border-ai-primary/20 hover:border-ai-primary/40 transition-all duration-300">
                ...
                <ul className="space-y-3">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        to={link.href}
                        className="flex items-center text-gray-300 hover:text-ai-primary transition-colors duration-200 group text-sm"
                      >
        ...
        <div className="text-center mt-12 flex flex-wrap gap-4 justify-center">
          <Link
            to="/more"
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-ai-primary to-ai-secondary text-white font-semibold rounded-lg hover:shadow-lg transition-all duration-300"
          >
            View All Resources
          ...
          <Link
            to="/seo"
            className="inline-flex items-center px-6 py-3 border border-ai-primary text-ai-primary font-semibold rounded-lg hover:bg-ai-primary hover:text-white transition-all duration-300"
          >
          ...
          <Link
            to="/products"
            className="inline-flex items-center px-6 py-3 border border-ai-secondary text-ai-secondary font-semibold rounded-lg hover:bg-ai-secondary hover:text-white transition-all duration-300"
          >
            View Products
            <ArrowRight className="ml-2 h-4 w-4" />
          </Link>
