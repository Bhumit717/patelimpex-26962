        ...
        return (
            <div className="min-h-screen bg-card flex flex-col">
                ...
                <div className="flex-1 flex flex-col items-center justify-center space-y-4">
                    <h1 className="text-4xl font-bold text-foreground uppercase font-graduate">Article Not Found</h1>
                    <Link to="/news">
        ...
        <div className="min-h-screen bg-card">
            ...
            <main className="pt-32 pb-20 animate-fade-in">
                <div className="container mx-auto px-4 max-w-4xl mb-8">
                    <Link to="/news" className="inline-flex items-center text-muted-foreground hover:text-accent-ink mb-8 transition-colors group uppercase font-graduate text-[10px] font-black tracking-widest">
                    ...
                    <article>
                        ...
                        <header className="mb-12">
                            <div className="flex items-center space-x-6 text-[10px] font-black text-muted-foreground uppercase tracking-widest font-graduate mb-6">
                                <div className="flex items-center space-x-2">
                                    <Calendar className="h-4 w-4 text-accent-ink" />
                                    <span>{article.date}</span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <Newspaper className="h-4 w-4 text-accent-ink" />
                                    <span>{article.category || 'Global Trade'}</span>
                                </div>
                            </div>
                            <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-foreground mb-8 leading-tight font-graduate uppercase">
                                {article.title}
                            </h1>
                        </header>
                    </article>
                ...
                <div className="w-full max-w-[900px] mx-auto px-4 mb-16">
                    <div className="relative aspect-[16/10] rounded-[40px] overflow-hidden  border-8 border-white group bg-secondary">
                        {article.image ? (
                            <img
                                src={article.image}
                                alt={article.title}
                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    <article>
                        ...
                        <div className="space-y-8">
                            <div
                                className="prose prose-slate prose-lg max-w-none text-muted-foreground leading-relaxed news-content-rendered font-fondamento text-xl"
                        ...
                        <footer className="mt-20 pt-12 border-t border-border flex flex-col md:flex-row md:items-center justify-between gap-8">
                            <div className="flex flex-wrap gap-2">
                                {article.tags?.map(tag => (
                                    <span key={tag} className="flex items-center space-x-1 bg-secondary text-muted-foreground px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest font-graduate border border-border">
                            ...
                            <div className="flex items-center space-x-4">
                                <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest font-graduate">Broadcast Intel:</span>
                                <Button
                                    size="icon"
                                    variant="ghost"
