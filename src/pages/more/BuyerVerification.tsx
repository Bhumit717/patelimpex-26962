...
const BuyerVerification = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead title="Buyer Verification | Patel Impex" description="Buyer Verification - Expert services and information by Patel Impex." canonicalUrl="/more/buyer-verification" />
      <Navigation />
