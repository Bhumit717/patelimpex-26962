...
const NonBasmatiRiceExport = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead title="Non Basmati Rice Export | Patel Impex" description="Non Basmati Rice Export - Expert services and information by Patel Impex." canonicalUrl="/more/non-basmati-rice-export" />
      <Navigation />
