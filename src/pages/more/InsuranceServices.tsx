...
const InsuranceServices = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <SEOHead title="Insurance Services | Patel Impex" description="Insurance Services - Expert services and information by Patel Impex." canonicalUrl="/more/insurance-services" />
      <Navigation />
