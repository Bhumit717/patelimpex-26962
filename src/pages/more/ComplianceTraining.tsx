...
const ComplianceTraining = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <SEOHead title="Compliance Training | Patel Impex" description="Compliance Training - Expert services and information by Patel Impex." canonicalUrl="/more/compliance-training" />
      <Navigation />
