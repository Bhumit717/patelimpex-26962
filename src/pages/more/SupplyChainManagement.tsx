...
const SupplyChainManagement = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead title="Supply Chain Management | Patel Impex" description="Supply Chain Management - Expert services and information by Patel Impex." canonicalUrl="/more/supply-chain-management" />
      <Navigation />
