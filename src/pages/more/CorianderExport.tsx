...
const CorianderExport = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead title="Coriander Export | Patel Impex" description="Coriander Export - Expert services and information by Patel Impex." canonicalUrl="/more/coriander-export" />
      <Navigation />
