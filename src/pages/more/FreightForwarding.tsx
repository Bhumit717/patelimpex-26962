...
const FreightForwarding = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead title="Freight Forwarding | Patel Impex" description="Freight Forwarding - Expert services and information by Patel Impex." canonicalUrl="/more/freight-forwarding" />
      <Navigation />
