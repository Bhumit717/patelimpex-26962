...
const SoutheastAsianMarkets = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead title="Southeast Asian Markets | Patel Impex" description="Southeast Asian Markets - Expert services and information by Patel Impex." canonicalUrl="/more/southeast-asian-markets" />
      <Navigation />
