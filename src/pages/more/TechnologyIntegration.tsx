...
const TechnologyIntegration = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <SEOHead title="Technology Integration | Patel Impex" description="Technology Integration - Expert services and information by Patel Impex." canonicalUrl="/more/technology-integration" />
      <Navigation />
