            ...
            <div className="text-center mb-12">
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 bg-accent-ink rounded-2xl flex items-center justify-center">
                  <Scale className="h-10 w-10 text-[hsl(var(--paper))]" />
                </div>
              </div>
              ...
              <div className="grid gap-8">
                ...
                <div className="bg-card rounded-2xl p-8  border border-border">
                  <div className="flex items-center mb-6">
                    <CheckCircle className="h-8 w-8 text-accent-ink mr-4" />
                ...
                <div className="bg-card rounded-2xl p-8  border border-border">
                  ...
                  <div className="prose prose-slate max-w-none">
                    <p className="text-muted-foreground mb-4">Patel Impex provides:</p>
                ...
                <div className="bg-card rounded-2xl p-8  border border-border">
                  <div className="flex items-center mb-6">
                    <Shield className="h-8 w-8 text-accent-ink mr-4" />
                ...
                <div className="bg-card rounded-2xl p-8  border border-border">
                  <div className="flex items-center mb-6">
                    <AlertTriangle className="h-8 w-8 text-accent-ink mr-4" />
                    <h2 className="text-2xl font-bold text-foreground">Limitations and Disclaimers</h2>
                  </div>
                  <div className="prose prose-slate max-w-none">
                    <ul className="text-muted-foreground space-y-2">
                ...
                <div className="bg-card rounded-2xl p-8  border border-border">
                  <div className="flex items-center mb-6">
                    <XCircle className="h-8 w-8 text-accent-ink mr-4" />
