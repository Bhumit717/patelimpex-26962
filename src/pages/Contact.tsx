        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h1 className="text-5xl lg:text-6xl font-black text-foreground mb-6">
              Contact <span className="text-accent-ink">Us</span>
            </h1>
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-3 mb-3">
                      <div className="w-12 h-12 rounded-[14px] bg-card shadow-[inset_3px_3px_6px_#cfd6e0,inset_-3px_-3px_6px_#ffffff] flex items-center justify-center">
                        <info.icon className="h-6 w-6 text-accent-ink" />
                      </div>
                      <h3 className="text-lg font-bold text-foreground flex items-center">
                        {info.title}
                        {info.clickable && (
                          <ExternalLink className="h-4 w-4 ml-2 text-accent-ink" />
                        )}
                      </h3>
                    </div>
                    {info.details.map((detail, idx) => (
                      <p key={idx} className="text-muted-foreground text-sm mb-1 ml-15 pl-1">
                        {detail}
                      </p>
                    ))}
                  </div>
            ...
            <div className="nm-card p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  ...
                  className="nm-btn w-full !h-auto py-3 text-lg font-semibold text-foreground hover:text-accent-ink group"
                >
