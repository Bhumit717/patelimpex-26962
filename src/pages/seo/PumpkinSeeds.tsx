...
const PumpkinSeeds = () => {
  return (
    <>
      <Helmet>
        <title>Pumpkin Seeds Export | Kaddu Seeds Export from India | Patel Impex</title>
        <meta name="description" content="Premium Pumpkin Seeds export from India. High-quality pumpkin seeds with international certifications and global shipping." />
        <meta name="keywords" content="pumpkin seeds export, kaddu seeds export, India seeds export, pumpkin supplier" />
        <link rel="canonical" href="https://patelimpex.com/seo/pumpkin-seeds" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-green-700 to-emerald-600 bg-clip-text text-transparent mb-6">
                Premium Pumpkin Seeds Export
              </h1>
              <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                Export premium Pumpkin Seeds worldwide. High-quality with complete documentation.
              </p>
            </div>
            ...
            <div className="text-center">
              <Link to="/contact" className="inline-flex items-center space-x-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl">
                ...
                <span>Export Pumpkin Seeds Globally</span>
              </Link>
            </div>
          </div>
        </main>
