...
const SorghumExport = () => {
  return (
    <>
      <Helmet>
        <title>Sorghum Export Services | Jowar Export from India | Patel Impex</title>
        <meta name="description" content="Premium Sorghum (Jowar) export from India. High-quality sorghum with international certifications." />
        <meta name="keywords" content="sorghum export, jowar export, India grain export, sorghum supplier" />
        <link rel="canonical" href="https://patelimpex.com/seo/sorghum-export" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-orange-700 to-yellow-600 bg-clip-text text-transparent mb-6">
                Premium Sorghum Export
              </h1>
              <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                Export premium Sorghum (Jowar) worldwide. High-quality with complete documentation.
              </p>
            </div>
            ...
            <div className="text-center">
              <Link to="/contact" className="inline-flex items-center space-x-3 bg-gradient-to-r from-orange-600 to-yellow-600 hover:from-orange-700 hover:to-yellow-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl">
                ...
                <span>Export Sorghum Globally</span>
              </Link>
            </div>
          </div>
        </main>
