...
const KenyaMarketExport = () => {
  return (
    <>
      <Helmet>
        <title>Kenya Export Services | Import Export to Kenya | Patel Impex</title>
        <meta name="description" content="Export to Kenya market with Patel Impex. Professional Kenyan import export services, customs clearance, EAC benefits for Kenya market entry." />
        <meta name="keywords" content="Kenya export, Kenyan import export, export to Kenya, Kenya market entry, Kenyan customs clearance, EAC East African Community" />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                East Africa's economic hub through Kenya. EAC advantages and comprehensive Kenyan export services for regional market penetration.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-red-100 text-center">
                ...
                <p className="text-slate-600">East Africa's largest economy with 54M consumers</p>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-red-100 text-center">
                <TrendingUp className="h-12 w-12 text-green-600 mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-slate-800 mb-4">Regional Hub</h3>
                <p className="text-slate-600">Gateway to East African Community markets</p>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-red-100 text-center">
                <Award className="h-12 w-12 text-blue-600 mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-slate-800 mb-4">Innovation Center</h3>
                <p className="text-slate-600">Silicon Savannah with tech innovation leadership</p>
              </div>
            </div>

            <div className="bg-white rounded-3xl p-12 shadow-xl border border-red-200 mb-16">
              <h2 className="text-4xl font-bold text-center text-slate-800 mb-12">Our Kenya Export Services</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  "Kenyan Customs Clearance",
                  "KEBS Standards Compliance", 
                  "PHARMACY & POISONS Registration",
                  "English & Swahili Documentation",
                  "Mombasa Port Services",
                  "Nairobi Distribution Hub",
            ...
            <div className="text-center">
              <Link to="/contact" className="inline-flex items-center space-x-3 bg-gradient-to-r from-red-600 to-green-600 hover:from-red-700 hover:to-green-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl">
                ...
                <span>Start Kenya Export Journey</span>
              </Link>
            </div>
          </div>
        </main>
