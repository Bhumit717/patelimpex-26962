...
const HazelnutExport = () => {
  return (
    <>
      <Helmet>
        <title>Hazelnut Export Services | Filbert Export from India | Patel Impex</title>
        <meta name="description" content="Premium Hazelnut (Filbert) export from India. High-quality hazelnuts export with international certifications and global shipping services." />
        <meta name="keywords" content="hazelnut export, filbert export, hazelnut nut export, India dry fruit export, hazelnut supplier, filbert exporter" />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-orange-700 to-amber-600 bg-clip-text text-transparent mb-6">
                Premium Hazelnut Export 🟤
              </h1>
              <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                Export authentic Indian Hazelnuts (Filberts) worldwide. Premium quality nutritious nuts with complete documentation and international shipping.
              </p>
            </div>
            ...
            <div className="text-center">
              <Link to="/contact" className="inline-flex items-center space-x-3 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl">
                ...
                <span>Export Hazelnuts Globally</span>
              </Link>
            </div>
          </div>
        </main>
