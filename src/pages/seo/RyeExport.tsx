...
const RyeExport = () => {
  return (
    <>
      <Helmet>
        <title>Rye Export Services | Rye Grain Export from India | Patel Impex</title>
        <meta name="description" content="Premium Rye export from India. High-quality rye grain with international certifications and global shipping." />
        <meta name="keywords" content="rye export, rye grain export, India grain export, rye supplier" />
        <link rel="canonical" href="https://patelimpex.com/seo/rye-export" />
      </Helmet>

      <div className="min-h-screen bg-gradient-to-br from-brown-50 to-amber-50">
        <Navigation />
        <WhatsAppChat />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                Export premium Rye worldwide. High-quality with complete documentation.
              </p>
            </div>
