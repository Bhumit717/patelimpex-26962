...
const MaceExport = () => {
  return (
    <>
      <Helmet>
        <title>Mace Export Services | Javitri Export from India | Patel Impex</title>
        <meta name="description" content="Premium Mace (Javitri) export from India. High-quality mace with international certifications." />
        <meta name="keywords" content="mace export, javitri export, India spice export, mace supplier" />
        <link rel="canonical" href="https://patelimpex.com/seo/mace-export" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                Export premium Mace (Javitri) worldwide. High-quality with complete documentation.
              </p>
            </div>
            ...
            <div className="text-center">
              <Link to="/contact" className="inline-flex items-center space-x-3 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl">
                ...
                <span>Export Mace Globally</span>
              </Link>
            </div>
          </div>
        </main>
