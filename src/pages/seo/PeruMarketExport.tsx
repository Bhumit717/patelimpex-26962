...
const PeruMarketExport = () => {
  return (
    <>
      <Helmet>
        <title>Peru Export Services | Import Export to Peru | Patel Impex</title>
        <meta name="description" content="Export to Peru market with Patel Impex. Professional Peruvian import export services, customs clearance, Pacific Alliance benefits for Peru market entry." />
        <meta name="keywords" content="Peru export, Peruvian import export, export to Peru, Peru market entry, Peruvian customs clearance, Pacific Alliance Peru" />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-red-700 to-slate-600 bg-clip-text text-transparent mb-6">
                Peru Market Export Services 🇵🇪
              </h1>
              <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                Ancient civilizations meet modern commerce in Peru. Pacific Alliance benefits and comprehensive Peruvian export services for Andean market access.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-red-100 text-center">
                ...
                <p className="text-slate-600">Rich in natural resources and agricultural diversity</p>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-red-100 text-center">
                <Award className="h-12 w-12 text-purple-600 mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-slate-800 mb-4">Cultural Heritage</h3>
                <p className="text-slate-600">Ancient Inca civilization with modern business opportunities</p>
              </div>
            </div>

            <div className="bg-white rounded-3xl p-12 shadow-xl border border-red-200 mb-16">
              <h2 className="text-4xl font-bold text-center text-slate-800 mb-12">Our Peru Export Services</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  "Peruvian Customs Clearance",
                  "INDECOPI Standards Compliance", 
                  "DIGESA Registration",
                  "Spanish Documentation",
                  "Callao Port Services",
                  "Lima Distribution Networks",
                  "Pacific Alliance Benefits",
                  "Peru Market Research",
                  "Textile & Mining Expertise"
                ].map((service, index) => (
            ...
            <div className="text-center">
              <Link to="/contact" className="inline-flex items-center space-x-3 bg-gradient-to-r from-red-600 to-slate-600 hover:from-red-700 hover:to-slate-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl">
                ...
                <span>Start Peru Export Journey</span>
              </Link>
            </div>
          </div>
        </main>
