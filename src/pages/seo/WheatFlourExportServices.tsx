    ...
    <div className="min-h-screen bg-slate-50">
      <Helmet>
        ...
        <script type="application/ld+json">
          {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the minimum order quantity for Wheat Flour export to Global Markets?","acceptedAnswer":{"@type":"Answer","text":"Our minimum order quantity for Wheat Flour to Global Markets typically starts from 1 FCL (Full Container Load), but we can arrange smaller trial shipments of 5-10 metric tons depending on the customized packaging requirements for the Global Markets market."}},{"@type":"Question","name":"What documents do you provide for importing Wheat Flour into Global Markets?","acceptedAnswer":{"@type":"Answer","text":"We provide a comprehensive set of documents including Commercial Invoice, Packing List, Bill of Lading, Certificate of Origin, Phytosanitary Certificate, and any specific quality test reports required by Global Markets customs authorities."}},{"@type":"Question","name":"What are the shipping times from India to Global Markets?","acceptedAnswer":{"@type":"Answer","text":"Transit times to Global Markets typically range from 45 days, depending on the specific port of discharge and shipping line schedules. We exclusively partner with top-tier logistics providers to ensure timely delivery of your Wheat Flour."}},{"@type":"Question","name":"Can you provide customized packaging for Wheat Flour in Global Markets?","acceptedAnswer":{"@type":"Answer","text":"Yes, we offer fully customizable packaging options for Wheat Flour, including private labeling, branding, and specific bag sizes (25kg, 50kg, retail packs) compliant with Global Markets's labeling and packaging regulations."}}]}
        </script>
      </Helmet>
      <Navigation />
      <div className="pt-32 pb-20 bg-green-900 text-white text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">Indian <span className="text-yellow-400">Wheat Flour</span> Export</h1>
        <p className="text-xl max-w-2xl mx-auto opacity-90">World-class quality Wheat Flour sourced from best farms</p>
      </div>
      <div className="container mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold mb-8 text-center text-slate-800">Why Our Wheat Flour?</h2>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-slate-800 mb-3">What is the minimum order quantity for Wheat Flour export to Global Markets?</h3>
              <p className="text-slate-600 leading-relaxed">Our minimum order quantity for Wheat Flour to Global Markets typically starts from 1 FCL (Full Container Load), but we can arrange smaller trial shipments of 5-10 metric tons depending on the customized packaging requirements for the Global Markets market.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-slate-800 mb-3">What documents do you provide for importing Wheat Flour into Global Markets?</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-600 leading-relaxed">Transit times to Global Markets typically range from 45 days, depending on the specific port of discharge and shipping line schedules. We exclusively partner with top-tier logistics providers to ensure timely delivery of your Wheat Flour.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-slate-800 mb-3">Can you provide customized packaging for Wheat Flour in Global Markets?</h3>
              <p className="text-slate-600 leading-relaxed">Yes, we offer fully customizable packaging options for Wheat Flour, including private labeling, branding, and specific bag sizes (25kg, 50kg, retail packs) compliant with Global Markets's labeling and packaging regulations.</p>
            </div>
          </div>
        </div>
      </div>
