...
const PecanExport = () => {
  return (
    <>
      <Helmet>
        <title>Pecan Export Services | Pecan Nuts Export from India | Patel Impex</title>
        <meta name="description" content="Premium Pecan nuts export from India. High-quality pecan export with international certifications and global shipping services." />
        <meta name="keywords" content="pecan export, pecan nuts export, pecan nut export, India dry fruit export, pecan supplier, pecan exporter" />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-yellow-700 to-orange-600 bg-clip-text text-transparent mb-6">
                Premium Pecan Export 🟡
              </h1>
              <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                Export authentic Pecan nuts worldwide. Premium quality buttery nuts with complete documentation and international shipping services.
              </p>
            </div>
            ...
            <div className="text-center">
              <Link to="/contact" className="inline-flex items-center space-x-3 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl">
                ...
                <span>Export Pecans Globally</span>
              </Link>
            </div>
          </div>
        </main>
