...
const Products = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen products-hub bg-secondary/50">
        <Navigation />

        <section className="pt-40 pb-24 px-6 bg-[hsl(var(--ink))] text-[hsl(var(--paper))] relative overflow-hidden">
          <div className="absolute top-0 right-0 w-[60vw] h-full bg-accent-ink/5 -skew-x-12 transform origin-top pointer-events-none" />
          
          <div className="container mx-auto max-w-7xl relative z-10">
            <div className="max-w-4xl">
              <Badge className="bg-accent-ink mb-8 px-6 py-2 text-xs uppercase tracking-[0.2em] font-black border-0">Global Trade Portfolio</Badge>
              <h1 className="text-6xl md:text-8xl font-black mb-8 font-graduate uppercase tracking-tighter leading-none">
                Specialized <span className="text-accent-ink italic font-fredericka lowercase">Products</span>
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {sectors.map((sector) => (
                <Link 
                  key={sector.id} 
                  to={sector.link} 
                  className="sector-card group bg-card rounded-[2.5rem] overflow-hidden flex flex-col h-full"
                >
                  <div className="sector-image-container relative h-72 overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-8 z-20">
                      <div className={`${sector.color} p-4 rounded-2xl  inline-block text-[hsl(var(--paper))]`}>
                  ...
                  <div className="p-10 flex-1 flex flex-col">
                    <h3 className="text-3xl font-black text-foreground font-graduate uppercase mb-6 group-hover:text-accent-ink transition-colors">
                      {sector.name}
                    </h3>
                    ...
                    <div className="mt-auto pt-8 border-t border-border flex items-center justify-between">
                      <span className="text-sm font-black uppercase tracking-widest text-foreground group-hover:translate-x-2 transition-transform inline-flex items-center gap-2">
        ...
        <section className="pb-24 px-6">
          <div className="container mx-auto max-w-7xl">
            <div className="bg-[hsl(var(--ink))] rounded-[3rem] p-12 md:p-20 text-center text-[hsl(var(--paper))] relative overflow-hidden ">
              <div className="absolute top-0 right-0 w-96 h-96 bg-accent-ink/10 rounded-full blur-[100px] pointer-events-none" />
              ...
              <Link to="/contact" className="bg-accent-ink hover:bg-accent-ink text-[hsl(var(--paper))] px-12 py-6 rounded-full font-black uppercase tracking-widest text-sm transition-all  inline-block hover:scale-105">
