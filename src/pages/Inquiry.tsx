      ...
      <main className="pt-40 pb-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            {features.map((f, i) => (
              <div key={i} className="bg-white p-8 border border-slate-100 text-center group hover:-translate-y-2 transition-all duration-300">
                <div className="w-14 h-14 bg-green-50 flex items-center justify-center mx-auto mb-6 group-hover:bg-green-600 transition-colors duration-300">
          ...
          <div className="max-w-5xl mx-auto bg-white p-10 md:p-16 relative overflow-hidden border border-slate-100">
            <div className="absolute top-0 right-0 w-64 h-64 bg-green-50 opacity-50 -z-10"></div>
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-blue-50 opacity-50 -z-10"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <input name="companyName" value={formData.companyName} onChange={handleInputChange} required className="w-full px-5 py-4 bg-slate-50 border-none focus:ring-2 focus:ring-green-500/20 focus:bg-white transition-all outline-none font-semibold text-slate-800 placeholder:text-slate-400" placeholder="Your Organization Ltd." />
                </div>
                <div className="space-y-3">
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest font-graduate">Contact Person</label>
                  <input name="contactPerson" value={formData.contactPerson} onChange={handleInputChange} required className="w-full px-5 py-4 bg-slate-50 border-none focus:ring-2 focus:ring-green-500/20 focus:bg-white transition-all outline-none font-semibold text-slate-800 placeholder:text-slate-400" placeholder="Hitesh Patel" />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <input type="email" name="email" value={formData.email} onChange={handleInputChange} required className="w-full px-5 py-4 bg-slate-50 border-none focus:ring-2 focus:ring-green-500/20 focus:bg-white transition-all outline-none font-semibold text-slate-800 placeholder:text-slate-400" placeholder="trade@email.com" />
                </div>
                <div className="space-y-3">
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest font-graduate">Phone Number</label>
                  <input name="phone" value={formData.phone} onChange={handleInputChange} required className="w-full px-5 py-4 bg-slate-50 border-none focus:ring-2 focus:ring-green-500/20 focus:bg-white transition-all outline-none font-semibold text-slate-800 placeholder:text-slate-400" placeholder="+91 00000 00000" />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <select name="country" value={formData.country} onChange={handleInputChange} required className="w-full px-5 py-4 bg-slate-50 border-none focus:ring-2 focus:ring-green-500/20 focus:bg-white transition-all outline-none font-semibold text-slate-800 appearance-none cursor-pointer">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <select name="inquiryType" value={formData.inquiryType} onChange={handleInputChange} required className="w-full px-5 py-4 bg-slate-50 border-none focus:ring-2 focus:ring-green-500/20 focus:bg-white transition-all outline-none font-semibold text-slate-800 appearance-none cursor-pointer">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <select name="budget" value={formData.budget} onChange={handleInputChange} className="w-full px-5 py-4 bg-slate-50 border-none focus:ring-2 focus:ring-green-500/20 focus:bg-white transition-all outline-none font-semibold text-slate-800 appearance-none cursor-pointer">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <select name="timeline" value={formData.timeline} onChange={handleInputChange} className="w-full px-5 py-4 bg-slate-50 border-none focus:ring-2 focus:ring-green-500/20 focus:bg-white transition-all outline-none font-semibold text-slate-800 appearance-none cursor-pointer">
              ...
              <div className="space-y-3">
                ...
                <textarea name="message" value={formData.message} onChange={handleInputChange} placeholder="Describe product specs, packaging needs, or designated port..." className="w-full px-5 py-4 bg-slate-50 border-none focus:ring-2 focus:ring-green-500/20 focus:bg-white transition-all outline-none font-semibold text-slate-800 placeholder:text-slate-400 min-h-[150px] resize-none" />
              </div>

              <button type="submit" disabled={isSubmitting} className="w-full py-5 bg-gradient-to-r from-green-600 to-emerald-700 text-white hover:-translate-y-1 active:translate-y-0 transition-all duration-300 flex items-center justify-center group font-bold font-graduate uppercase tracking-widest text-sm">
